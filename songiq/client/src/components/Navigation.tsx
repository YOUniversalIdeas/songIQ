...
import { Home, Upload, BarChart3, TrendingUp, BarChart, TrendingUp as TrendingUpIcon, Zap, User, LogOut, Settings, CreditCard, ChevronDown, Music, Globe } from 'lucide-react'
        ...
        <div className="flex flex-col min-w-0">
          ...
          <div className="flex space-x-4 lg:space-x-8 min-w-0 justify-center py-2">
            {navigationItems.map((item) => {
              ...
              // Handle Platforms dropdown
              if (item.hasDropdown) {
                return (
                  <div key={item.path} className="relative" ref={platformsDropdownRef}>
                    <button
                    ...
                    >
                      ...
                      <ChevronDown className={`h-3 w-3 lg:h-4 lg:w-4 transition-transform ${isPlatformsDropdownOpen ? 'rotate-180' : ''}`} />
                    </button>
